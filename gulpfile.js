 ...
 * @param  {Array|String}   path - array of paths to delete
 * @param  {Function} done - callback when complete
 */
 ...
 * @param   {Array|Stream|String} src   glob pattern for source files
...
/**
 * Order a stream
 * @param   {Array|Stream} src   The gulp.src stream
...
function serve(isDev, specRunner) {
	...
	nodeOptions.nodeArgs = [debugMode + '=5262'];
